...
export default function BillingCart() {
  ...
  return (<>
  {cards?cards.map(card=><div key={card.id} className="col-xl-6 mb-xl-0 mb-4">
...
<div className="overflow-hidden position-relative border-radius-xl">
        ...
        <div className="card-body position-relative z-index-1 p-3">
          ...
          <h5 className="text-white mt-4 mb-5 pb-2">{card.cardNumber}</h5>
          <div className="d-flex">
            <div className="d-flex">
              <div className="me-4">
                <p className="text-white text-sm opacity-8 mb-0">Card Holder</p>
                <h6 className="text-white mb-0">{card.cardHolder}</h6>
              </div>
              <div>
                <p className="text-white text-sm opacity-8 mb-0">Expires</p>
                <h6 className="text-white mb-0">{card.expired}</h6>
              </div>
            </div>
            <div className="ms-auto w-20 d-flex align-items-end justify-content-end">
              <img className="w-60 mt-2" src={`${card.logo}`} alt="logo"/>
            </div>
          </div>
        </div>
      </div>
